...
/** @type {DBMAction} */
module.exports = {
    name: "Store Map Entries [DBM German]",
    displayName: "Store Map Entries",
    section: "Maps and Sets",

    subtitle(data, presets) {
        return /* html */ `Store Entries from ${presets.getVariableText(data.storage, data.varName)} as List of Key-Value Pairs`;
    },
    ...
    async action(cache) {
        ...
        this.storeValue(entries, storage2, varName2, cache);
