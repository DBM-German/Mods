...
/** @type {DBMAction} */
module.exports = {
    name: "Store Map Entry [DBM German]",
    displayName: "Store Map Entry",
    section: "Maps and Sets",

    subtitle(data, presets) {
        return /* html */ `Store Entry from ${presets.getVariableText(data.storage, data.varName)}`;
    },
    ...
    async action(cache) {
        ...
        this.storeValue(entry, storage2, varName2, cache);
